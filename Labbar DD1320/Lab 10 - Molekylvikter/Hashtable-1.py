...
class Hashtable:
    ...
    def store(self, key, data):  # här skall krockhanteringen läggas till
        ...
        if self.newtable[hashnyckel] == None: #om indexet är none skapa ett objekt och lägg in på det indexet
            ...
            current = self.newtable[hashnyckel]  # här sker krockhanteringen
